...
namespace ManageSheetSpecs
{
    public class CreateRibbonTab
    {
        ...
        const string Message = "Update Sheet Specs from Word Document.";
        ...
        private static BitmapImage NewBitmapImage(Assembly a, string imageName)
        {
            ...
            Stream s = Assembly.GetExecutingAssembly().GetManifestResourceStream("ManageSheetSpecs.Graphics." + imageName);
        ...
        public void tabAndButtons(UIControlledApplication UIConApp)
        {
            ...
            d.ToolTip = "Export and Update Sheet Specs";
